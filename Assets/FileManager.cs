...
public class FileManager : MonoBehaviour
{
    ...
    private string base64Instagram =
    ...
    {
        byte[] imageBytes = Convert.FromBase64String(base64Instagram);
        Texture2D tex = new Texture2D(100, 100);
        tex.LoadImage(imageBytes);
        rawImage.texture = tex;

        // path = EditorUtility.OpenFilePanel("Select any Png", "", "png");
        // Coroutine coroutine = StartCoroutine(GetTexture());
    }
